...
HD_PWD='T:/engs31/finalproject/vga_test/vga_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_driver1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_driver1.tcl

...
HD_PWD='T:/engs31/finalproject/vga_test/vga_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_driver1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_driver1.tcl -notrace

...
HD_PWD='T:/engs31/finalproject/vga_driver_part4_2/vga_driver_part4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_driver_part3_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_driver_part3_1.tcl

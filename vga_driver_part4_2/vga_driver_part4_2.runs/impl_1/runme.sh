...
HD_PWD='T:/engs31/finalproject/vga_driver_part4_2/vga_driver_part4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_driver_part3_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_driver_part3_1.tcl -notrace

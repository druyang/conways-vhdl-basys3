...
HD_PWD='O:/engs31/finalproject/project_with_topshell_1/project_with_topshell_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_topshell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_topshell.tcl

...
HD_PWD='O:/engs31/finalproject/project_with_topshell_1/project_with_topshell_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_topshell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_topshell.tcl -notrace
